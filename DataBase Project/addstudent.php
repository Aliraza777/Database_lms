...
if(isset($_POST['add'])){
$add = "INSERT INTO students (student_name , roll_no , dep_id , phone , username , pass , email) 
VALUES ('".$_POST['studentname']."','" .$_POST['rollno']."' ,'" .$_POST['dep_id']."', '" .$_POST['phone']."' , '" .$_POST['username']."' , '" .$_POST['pass']."' , '" .$_POST['email']."')";
