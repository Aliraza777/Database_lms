...
$pass = $_POST['pass'];
$email = $_POST['email'];
$update = "UPDATE students SET student_name='$name', roll_no = '$rollno' , dep_id='$department_id', phone ='$phone', username='$user', pass = '$pass',email='$email' WHERE student_id=". $_GET['id'];
...
<div class="limiter">
    ...
    <span class="login100-form-title p-b-33">
    				...
    				<div class="wrap-input100 validate-input" required>
						<input class="input100" type="text" name="studentname" placeholder="Student Name" value="<?php echo htmlspecialchars ($row['student_name']) ?>">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
					</div>
    
					<div class="wrap-input100 rs1 validate-input" data-validate="Roll no. is required">
						<input class="input100" type="number" name="rollno" placeholder="Roll No." value="<?php echo htmlspecialchars ($row['roll_no']) ?>">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
                    </div>
					
					<div class="wrap-input100 rs1 validate-input" data-validate="Phone is required">
						<input class="input100" type="text" name="phone" placeholder="Phone No." value="<?php echo htmlspecialchars ($row['phone']) ?>">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
                    </div>
					...
					<div class="wrap-input100 rs1 validate-input" data-validate="Password is required">
						<input class="input100" id="pass" type="password" name="pass" placeholder="Password" value="<?php echo htmlspecialchars ($row['pass']) ?>">
						<span class="focus-input100-1"></span>
						<span class="focus-input100-2"></span>
